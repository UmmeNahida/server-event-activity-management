/*
  ...
  - The values [FULL,Cancelled] on the enum `EventStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EventStatus_new" AS ENUM ('OPEN', 'CLOSED', 'CANCELLED', 'COMPLETED');
